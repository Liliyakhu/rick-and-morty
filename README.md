...
### Requirements:
1. Endpoint, which returns random character from the world of Rick and Morty series.
2. Endpoint gets `search_string` as an argument and returns list of all characters, who contains the `search_string` in the name.
